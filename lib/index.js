 ...
 * API function
 */
Spread2Json.prototype.generateAuthUrl = function() { api.generateAuthUrl.apply(api, arguments); };
Spread2Json.prototype.getAccessToken = function() { api.getAccessToken.apply(api, arguments); };
Spread2Json.prototype.refreshAccessToken = function() { api.refreshAccessToken.apply(api, arguments); };
            ...
            entry.forEach(function(cell) {
                ...
                format.keys.forEach(function(_key, i) {
                    ...
                    if (format.type === 'number') {
                        data[_key] = Number(content);
                        return;
                    }
                    if (format.type === 'boolean') {
                        data[_key] = content === 'TRUE';
                        return;
                    }
                    if (format.type === 'date') {
